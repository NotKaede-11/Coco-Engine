...
g++ -O3 -march=native -pthread -static -std=c++23 -DL1_SIZE=512 -DNDEBUG src/main.cpp src/board.cpp src/movegen.cpp src/tt.cpp src/search.cpp src/evaluate.cpp src/uci.cpp src/nnue.cpp src/datagen.cpp Fathom/src/tbprobe.c -IFathom/src -o coco-chess.exe
if errorlevel 1 (
